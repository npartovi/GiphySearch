...
import { renderTrendingGifs, renderFavoriteGifs, updateSearchTerm } from '../../actions/giphyAPI'
            ...
            <nav className="navbar-container">
                <div className="navbar-wrapper">
                    ...
                    <div className="links-bar-container">
                        ...
                        <a href="/" onClick={this.renderRandom} className="btn"><span>Random<i className="fas fa-random fa-lg"></i></span></a>
                    </div>
                </div>
            </nav>
        )
...
export default connect(mapStateToProps, {renderTrendingGifs, renderFavoriteGifs, updateSearchTerm})(NavBar)
